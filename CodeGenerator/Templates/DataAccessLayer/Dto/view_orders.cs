...
namespace DataAccessLayer.Dto
{
    ...
    public partial class view_orders
    {
        ...
        [Column(TypeName = "datetime")]
        public DateTime _agreedate2 { get; set; }
        [Column(TypeName = "numeric(15, 4)")]
        public decimal? seller_discount { get; set; }
        [Column(TypeName = "numeric(15, 4)")]
        public decimal? seller_discount2 { get; set; }
        [Column(TypeName = "numeric(15, 4)")]
        public decimal? seller_discount3 { get; set; }
        [Column(TypeName = "numeric(15, 4)")]
        public decimal? customer_discount2 { get; set; }
        [Column(TypeName = "numeric(15, 4)")]
        public decimal? customer_discount3 { get; set; }
        public int? customer_face { get; set; }
        [StringLength(64)]
        [Unicode(false)]
        public string? docoper_group { get; set; }
        public int? docoper_addint { get; set; }
        [StringLength(256)]
        [Unicode(false)]
        public string? docoper_addstr { get; set; }
        [StringLength(128)]
        [Unicode(false)]
        ...
        [StringLength(194)]
        [Unicode(false)]
        public string? people_fio4 { get; set; }
        [StringLength(256)]
        [Unicode(false)]
        ...
        [StringLength(512)]
        [Unicode(false)]
        public string? advertisingaction_name { get; set; }
        ...
        [StringLength(194)]
        [Unicode(false)]
        public string? people_fio_designer { get; set; }
