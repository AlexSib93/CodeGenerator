...
{
    [Keyless]
    public partial class view_orderitem_model
    {
        ...
        public double? sqr_model { get; set; }
        public double? sqr_rama { get; set; }
        [StringLength(64)]
        [Unicode(false)]
        public string? model_colorin { get; set; }
        [StringLength(64)]
        [Unicode(false)]
        public string? model_colorout { get; set; }
        [StringLength(64)]
        [Unicode(false)]
        public string? model_ct { get; set; }
